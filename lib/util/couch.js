 ...
 *  Restart a server.
 */
Couch.prototype.restart = function(opts, cb) {
  if(typeof opts === 'function') {
    cb = opts;
    opts = null;
  }
 ...
 */
Couch.prototype.stats = function(opts, cb) {
  if(typeof opts === 'function') {
    cb = opts;
    opts = null;
  }
 ...
 */
Couch.prototype.uuids= function(opts, cb) {
  if(typeof opts === 'function') {
    cb = opts;
    opts = null;
  }
 ...
 */
Couch.prototype.session = function(opts, cb) {
  return {
    get: function(opts, cb) {
      if(typeof opts === 'function') {
        cb = opts;
